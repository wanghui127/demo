...
import com.example.demo.entity.output.ImageOutputMessage;
import com.example.demo.entity.output.MusicOutputMessage;
import com.example.demo.entity.output.NewsOutputMessage;
import com.example.demo.entity.output.OutTextMessage;
import com.example.demo.entity.output.VideoOutPutMessage;
import com.example.demo.entity.output.VoiceOutputMessage;
...
public class ReplyMessageUtil implements Serializable {
     ...
     * @return
     */
    public static String sendTextMessage(OutTextMessage message) {
        StringBuffer sb = new StringBuffer();
        sb.append("<xml>");
        sb.append("<ToUserName><![CDATA[" + message.getToUserName() + "]]></ToUserName>");
        sb.append("<FromUserName><![CDATA[" + message.getFromUserName() + "]]></FromUserName>");
